...
export class AdminAppsRequestsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdminAppsRequestsListRequest extends SpeakeasyBase {
  /**
...
export class AdminAppsRequestsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
