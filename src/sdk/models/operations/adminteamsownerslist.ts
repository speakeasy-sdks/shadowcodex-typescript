...
export class AdminTeamsOwnersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdminTeamsOwnersListRequest extends SpeakeasyBase {
  /**
...
export class AdminTeamsOwnersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
