...
export class UsersConversationsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class UsersConversationsRequest extends SpeakeasyBase {
  /**
...
export class UsersConversationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  usersConversationsErrorSchema?: Record<string, Record<string, any>>;
   ...
   */
  @SpeakeasyMetadata()
  usersConversationsSuccessSchema?: Record<string, Record<string, any>>;
}
