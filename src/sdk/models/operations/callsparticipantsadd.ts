...
export class CallsParticipantsAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CallsParticipantsAddApplicationJSON extends SpeakeasyBase {
  /**
...
export class CallsParticipantsAddRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "request, media_type=application/json" })
  requestBody: CallsParticipantsAddApplicationJSON;
...
export class CallsParticipantsAddResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
